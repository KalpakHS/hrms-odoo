...
export const EmployeeProfileModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 font-sans overflow-y-auto">
      <div className="bg-white border border-slate-200/80 rounded-[36px] w-full max-w-4xl max-h-[90vh] shadow-floating-lg overflow-hidden flex flex-col my-auto animate-in fade-in zoom-in-95 duration-200">
