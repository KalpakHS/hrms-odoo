...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0F1F4B] text-[#FFFFFF] pt-24 pb-12 relative overflow-hidden">
      
      {/* Decorative radial gradient blob in navy space */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#3B82F6]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-12 pb-16 border-b border-blue-900/40">
          <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div className="flex flex-col gap-3.5">
              ...
              <a href="#home" className="text-xs font-semibold text-slate-300 hover:text-[#3B82F6] transition-colors">Home</a>
              <a href="#features" className="text-xs font-semibold text-slate-300 hover:text-[#3B82F6] transition-colors">Features</a>
            </div>
            <div className="flex flex-col gap-3.5">
              <span className="text-[10px] font-extrabold uppercase tracking-widest text-slate-500">Platform</span>
              <a href="#workflow" className="text-xs font-semibold text-slate-300 hover:text-[#3B82F6] transition-colors">Workflow</a>
              <a href="#about" className="text-xs font-semibold text-slate-300 hover:text-[#3B82F6] transition-colors">About</a>
            </div>
            <div className="flex flex-col gap-3.5 col-span-2 sm:col-span-1">
              ...
              <a href="#signin" className="text-xs font-semibold text-slate-300 hover:text-[#3B82F6] transition-colors">Sign In</a>
            </div>
          </div>
        </div>
        ...
        <div className="py-20 relative select-none pointer-events-none flex flex-col items-center justify-center overflow-hidden">
          ...
          <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-xs md:text-sm font-bold uppercase tracking-[0.45em] text-[#3B82F6]/90 whitespace-nowrap block pt-2.5 font-mono">
            Human Resource Management System
          </span>
        </div>

        {/* Bottom copyright/legal segment */}
        <div className="pt-8 border-t border-blue-900/40 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] font-semibold text-slate-500">
          <div>
